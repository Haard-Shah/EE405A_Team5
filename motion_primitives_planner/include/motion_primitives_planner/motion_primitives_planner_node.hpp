...
class MotionPlanner
{
  public:
    ...
    double DIST_RESOL = 0.2; // [m] distance resolution for rollout was 0.2
    double TIME_RESOL = 0.05; // [sec] time resolution between each motion (for rollout) was 0.05
    ...
    double MAX_PROGRESS = 4.0; // [m] max progress of motion was 5 and then 3
    double INFLATION_SIZE = 0.6 / DIST_RESOL; // [grid] inflation size [m] / grid_res [m/grid] was 0.5
